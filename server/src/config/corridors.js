...
const ALL_RAILS = [...CANONICAL_RAILS, ...LEGACY_RAILS];
...
const CORRIDOR_CONFIG = {
  ...
  corridors: {
    ...
    'USD-BRL': { eligibleRails: ['SWIFT_CORRESPONDENT', 'SWIFT_BATCH', 'INSTANT_PAYMENT_LINK', 'REGIONAL_INSTANT', 'CARD_PAYOUT', 'CARD_PUSH'], maxAmountUSD: 2000000, baseSpreadBps: 55 },
    'USD-MXN': { eligibleRails: ALL_RAILS, maxAmountUSD: 3000000, baseSpreadBps: 45 },
    'EUR-BRL': { eligibleRails: ['SWIFT_CORRESPONDENT', 'SWIFT_BATCH', 'CARD_PAYOUT', 'CARD_PUSH'], maxAmountUSD: 1500000, baseSpreadBps: 60 },
    ...
    'USD-ZAR': { eligibleRails: ['SWIFT_CORRESPONDENT', 'SWIFT_BATCH', 'CARD_PAYOUT', 'CARD_PUSH'], maxAmountUSD: 1000000, baseSpreadBps: 70 },
  }
};
